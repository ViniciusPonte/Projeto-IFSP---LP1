...
<html>
    ...
    <body>
        ...
        <?php
                ...
                echo "<div><h1 class='text-center' id='titulo-adicionar'>Adicionar um produto</h1>
                    <div class='row'>
                        <form action='IncluirItem.php' method='post'>
                                 <label class='labeladd'>Nome do produto: </label> <input type='text' name='nome' size='40' maxlength='40' required/><br/><br/>
                              ...
                              <label class='labeladd'>Imagem: </label> <input type='text' name='imagem' size='50' maxlength='50' value='imagens/produtos/' required /><br/><br/>
                              <label class='labeladd'>Valor: </label> <input type='number' name='valor' min='1' max='50000' value='0' required />,00 <br/><br/>
                              <label class='labeladd'>Marca: </label> <input type='text' name='marca' size='50' maxlength='30' required/><br/><br/>
                              <label class='labeladd'>Descrição: </label> <textarea name='descricao' rows='20' cols='50' style='height: 20%;'></textarea><br/><br/>
                              <button type='submit' class='btn blue-gradient right'><a class='botao-comprar'>Cadastrar</a></button>
                              </form>
                            </div>
                        </div>";
